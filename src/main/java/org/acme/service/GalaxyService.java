...
import org.acme.entity.LightSaber;
...
public class GalaxyService {
    ...
    public List<List<Hero>> getHeroesForAllFilms(List<Film> films) {
        List<List<Hero>> allHeroesByFilm = new ArrayList<>();
        for (Film film: films) {
            allHeroesByFilm.add(getHeroesByFilm(film));
        }
        return allHeroesByFilm;
    }
